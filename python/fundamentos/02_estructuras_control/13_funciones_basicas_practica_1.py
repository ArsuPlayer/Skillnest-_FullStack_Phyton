...
#Esta función genera un error ya que la función "mensajes_en_chat" no está definida
...
#Variables | Valores
#Salida: 2022
#El segundo return  no llega a ejecutarse ya que
...
#Variables | Valores
#Salida: 12
#El primer print no llega a ejecutarse 
...
# x        | None
#Salida: 24
# x no imprime nada porque la función no tiene valor de retorno
